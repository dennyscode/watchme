...
const Movie = ( { movie }) => {
  ...
  return (
    <div className="container max-w-4xl mx-auto pt-6">
        ...
        <div className="px-3">
            <Image src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} loader={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} width={1000} height={600} className="rounded-md"></Image>
